        ...
        {commits?.map((commit,commitIdx) => {
            return <li key = {commit.id} className='relative flex gap-x-4'>
              <div className={cn(
                    ...
                    'absolute left-0 top-0 flex w-6 justify-content'
              )}>
              ...
              <>
              <img src={commit.commitAuthorAvatar} alt="commmit avatar" className='relative mt-4 size-12 flex-none rounded-full bg-gray-50' />
